...
export function DraggableExercise({ exercise, onAdd, onDelete, onRename, onUpdate, isEditMode }: DraggableExerciseProps) {
    ...
    const handleBlur = (e: React.FocusEvent) => {
        // Check if the new focus is still within the form
...
function Section({ title, exercises, onAddExercise, onAddToPlan, onDeleteExercise, onDeleteSection, onRenameSection, onRenameExercise, onUpdateExercise, isEditMode }: SectionProps) {
